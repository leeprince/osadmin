...
<div class="btn-toolbar" style="margin-bottom:2px;">
    ...
    <{if in_array('/panel/user_add.php', $operator_url)}>
	...
	<form class="form_search"  action="" method="GET" style="margin-bottom:0px">
		<div style="float:left;margin-right:5px;margin-top:10px;">
			<{html_options name=user_group id="DropDownTimezone" style="width:200px;" class="input-xlarge" options=$group_options selected=$_GET.user_group}>
		</div>

		<div style="float:left;margin-right:5px;margin-top:10px;">
			<input type="text" name="user_name" value="<{$_GET.user_name}>" style="width:150px;" class="selectName" placeholder="查询所有登录名请留空" > 
    ...
    <div id="page-stats" class="block-body collapse in">
          ...
          <tbody>							  
            <{foreach $user_infos as $user_info}>				 
				...
				<{if in_array('/panel/user_modify.php', $operator_url)}>
				<a href="user_modify.php?user_id=<{$user_info.user_id}>" title= "修改" ><i class="icon-pencil"></i></a>
				&nbsp;
				<{/if}>
				
				<{if in_array('/panel/users.php', $operator_url)}>
