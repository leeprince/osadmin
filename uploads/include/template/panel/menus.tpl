...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <{if in_array('/panel/menu_add.php', $operator_url)}>
	...
	<form class="form_search"  action="" method="GET" style="margin-bottom:0px">
		<div style="float:left;margin-right:5px;margin-top:10px;">
			<{html_options name=module_id id="DropDownTimezone" style="width:200px;" class="input-xlarge" options=$module_options_list selected=$_GET.module_id}>
		</div>

		<div style="float:left;margin-right:5px;margin-top:10px;">
			<input type="text" name="menu_name" value="<{$_GET.menu_name}>" style="width:150px;" class="selectName" placeholder="输入菜单名称" >
    ...
    <div id="page-stats" class="block-body collapse in">
          ...
          <tbody>							  
            <{foreach $menus as $menu}>
				...
				<td>
				<{if in_array('/panel/menu_modify.php', $operator_url)}>
				<a href="menu_modify.php?menu_id=<{$menu.menu_id}>" title= "修改" ><i class="icon-pencil"></i></a>
				<{/if}>
				
				<{if in_array('/panel/menus.php', $operator_url)}>
					<{if $menu.menu_id > 100}>
					&nbsp;
