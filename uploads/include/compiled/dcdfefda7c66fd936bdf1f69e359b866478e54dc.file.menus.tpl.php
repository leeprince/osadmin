<?php /* Smarty version Smarty-3.1.15, created on 2017-09-19 12:56:46
         compiled from "E:\phpstudy\WWW\jgx_admin\uploads\include\template\panel\menus.tpl" */ ?>
<?php /*%%SmartyHeaderCode:917859bfadf1c43ff9-12772084%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcdfefda7c66fd936bdf1f69e359b866478e54dc' => 
    array (
      0 => 'E:\\phpstudy\\WWW\\jgx_admin\\uploads\\include\\template\\panel\\menus.tpl',
      1 => 1505797004,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '917859bfadf1c43ff9-12772084',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_59bfadf1c8e397_28143855',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_59bfadf1c8e397_28143855')) {function content_59bfadf1c8e397_28143855($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'E:\\phpstudy\\WWW\\jgx_admin\\uploads\\include\\config/../../include/lib/Smarty/plugins\\function.html_options.php';
...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <?php if (in_array('/panel/menu_add.php',$_smarty_tpl->tpl_vars['operator_url']->value)) {?>
	...
	<form class="form_search"  action="" method="GET" style="margin-bottom:0px">
		<div style="float:left;margin-right:5px;margin-top:10px;">
			<?php echo smarty_function_html_options(array('name'=>'module_id','id'=>"DropDownTimezone",'style'=>"width:200px;",'class'=>"input-xlarge",'options'=>$_smarty_tpl->tpl_vars['module_options_list']->value,'selected'=>$_smarty_tpl->tpl_vars['_GET']->value['module_id']),$_smarty_tpl);?>

		</div>

		<div style="float:left;margin-right:5px;margin-top:10px;">
			<input type="text" name="menu_name" value="<?php echo $_smarty_tpl->tpl_vars['_GET']->value['menu_name'];?>
" style="width:150px;" class="selectName" placeholder="输入菜单名称" >
...
<?php }?></td>
				...
				<td>
				<?php if (in_array('/panel/menu_modify.php',$_smarty_tpl->tpl_vars['operator_url']->value)) {?>
				<a href="menu_modify.php?menu_id=<?php echo $_smarty_tpl->tpl_vars['menu']->value['menu_id'];?>
" title= "修改" ><i class="icon-pencil"></i></a>
				<?php }?>
				
				<?php if (in_array('/panel/menus.php',$_smarty_tpl->tpl_vars['operator_url']->value)) {?>
