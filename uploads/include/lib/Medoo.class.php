...
class Medoo{
	...
	public function query($query)
	{
		...
		return $this->pdo->query($query)?:$this->errorLog();
	}
	...
	public function exec($query)
	{
		...
		return $this->pdo->exec($query)?:$this->errorLog();
	}

	public function quote($string)
	{
		return $this->pdo->quote($string)?:$this->errorLog();
	}
	...
	// Medoo 扩展版本: 1.1.3 _20170912 _leeprince
