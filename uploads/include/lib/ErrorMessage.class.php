...
class ErrorMessage {
	...
	// 站点模块管理
	const HAVE_AREA      = "区域被使用，不能删除；若要删除，请先将属于该区域的站点划拨到其它区域";
	const AREA_NOT_EXIST = "区域不存在";
	const AREA_EXIST     = "区域已存在";
	const SITE_NOT_EXIST = "站点不存在";
	const SITE_EXIST     = "站点已存在";
	const LACK_PARAM     = "缺少相应参数";
